...
setup(
    name='fgel',
    version='0.1.0',
    description='Functional Generalized Empirical Likelihood Estimation for Conditional Moment Restrictions',
    ...
    install_requires=['numpy', 'scipy', 'cvxpy', 'torch', 'torchvision', 'sklearn', 'matplotlib', 'tensorflow',
                      'tqdm', 'tensorflow_probability', 'IPython', 'cvxopt', 'wandb', 'seaborn'],
)
